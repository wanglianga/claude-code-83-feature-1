...
export const disinfectToolKit = (barberId, data) => request.post(`/barbers/${barberId}/toolkit/disinfect`, data || {})
...
// 工具消毒安全与交叉感染追溯
export const listBackupKits = () => request.get('/tool-safety/backup-kits')
export const createBackupKit = (data) => request.post('/tool-safety/backup-kits', data)
export const listPendingDisinfection = () => request.get('/tool-safety/pending-disinfection')
export const recordDisinfection = (id, data) => request.post(`/tool-safety/kits/${id}/disinfection`, data)
export const handleToolIssue = (data) => request.post('/tool-safety/issues', data)
export const listToolIssues = (params) => request.get('/tool-safety/issues', { params })
export const reviewCompensation = (id, data) => request.post(`/tool-safety/issues/${id}/compensation`, data)
export const reportInfection = (data) => request.post('/tool-safety/infections', data)
export const listInfections = (params) => request.get('/tool-safety/infections', { params })
export const infectionDetail = (id) => request.get(`/tool-safety/infections/${id}`)
export const notifyContact = (id) => request.post(`/tool-safety/contacts/${id}/notify`)
export const recordContactResult = (id, data) => request.post(`/tool-safety/contacts/${id}/result`, data)
export const confirmInfectionResponsibility = (id, data) => request.post(`/tool-safety/infections/${id}/confirm`, data)
export const resolveInfection = (id, data) => request.post(`/tool-safety/infections/${id}/resolve`, data)
